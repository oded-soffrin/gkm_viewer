...
class EtsyProduct extends React.Component {
  ...
  render() {
    ...
    const { product, listings, addItemtoCategory, addListingToProduct } = this.props;
    ...
    return (
      <div className='gkm-etsy-product' id={product.id}>
        ...
        <div>
          ...
          <Input title="add category" fld='location' resetOnClick={true} button={{ text: 'ADD!', action: (hashtag) => { this.onAddtoCategory(location.hashtag) } }} />
